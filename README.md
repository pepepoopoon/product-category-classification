...
между train/validation/test. `FeatureUnion` объединяет word TF-IDF (1–2-граммы) и char
TF-IDF (3–5-граммы), после чего обучается логистическая регрессия. Модель, метаданные,
назначения частей и отложенный test сохраняются в `artifacts/`.
