...
Параметры и сводка 89 выполненных запусков описаны в
...
На синтетическом baseline test macro-F1 и top-2 accuracy равны `1.0000`. В наиболее
строгом совместном стресс-сценарии test macro-F1 снизился до `0.7389`, а top-2 accuracy —
до `0.9444`. Эти значения проверяют pipeline и его чувствительность, но не переносятся
на реальный каталог без внешней оценки.
